 ...
 */
public class SendEventThread implements KeyListener, MouseMotionListener, MouseListener{
    ...
    public SendEventThread(Socket s, JPanel p, String width, String height) {
        cSocket = s;
        cPanel = p;
        this.width = width;
        this.height = height;
